...
class UserRecommendationPreference(Base):
    ...
    use_taste_discovery: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    use_feedback: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    discovery_language: Mapped[str] = mapped_column(String(10), default="", nullable=False)
