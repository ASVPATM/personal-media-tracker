...
DEFAULT_PREFERENCES: dict[str, Any] = {
    ...
    "music_artwork_tint": False,
    "music_artwork_full_color": False,
    "music_artwork_reveal": False,
    "books_artwork_tint": False,
    "books_artwork_full_color": False,
    "books_artwork_reveal": False,
    "music_show_counts": False,
    "books_show_counts": False,
...
PORTABLE_PREFERENCE_KEYS = frozenset(
    {
        ...
        "show_tile_view_counts",
        "artwork_reveal",
        "music_artwork_tint",
        "music_artwork_full_color",
        "music_artwork_reveal",
        "books_artwork_tint",
        "books_artwork_full_color",
        "books_artwork_reveal",
        "music_show_counts",
        "books_show_counts",
